...
data_dir = "/home/jonny/projects/mobile_aloha_world/episodes/task1/post_proc"

class ReplayEpisodes:
    def __init__(self, data_dir):
        self.data_dir = data_dir
        self.robot = None # self.connect_to_robot()
        self.esp32 = "http://192.168.1.182"
    
    def read_file(self, index):
        cam_name = 'base'#'top'
        dataset_file = os.path.join(self.data_dir, f'pp_episode_{index}.hdf5')
